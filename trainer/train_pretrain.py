...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="HelloModel Pretraining")
    ...
    parser.add_argument("--max_seq_len", default=512, type=int, help="最大截断长度")
    parser.add_argument("--use_moe", default=0, type=int, choices=[0, 1], help="是否用MoE")
    ...
    parser.add_argument("--wandb_project", type=str, default="HelloModel-Pretrain", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"HelloModel-Pretrain-E{args.epochs}-B{args.batch_size}-LR{args.learning_rate}"
        wandb.init(
