...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="HelloModel GRPO (Group Relative Policy Optimization)"
    )
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="HelloModel-GRPO", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"HelloModel-GRPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
